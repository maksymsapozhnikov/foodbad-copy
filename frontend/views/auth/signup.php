...
<div class="bg-image auth-page">
    <header>
        <div class="header-wrapper">
            ...
            <div class="header-button">
                <button href="#" class="sign-up-button">Sign Up</button>
            </div>
        </div>
    ...
    <main class="">
        <section class="sign-up-prompting">
            <h1 class="sign-up-title">Let’s get you signed up.</h1>
            <div class="sign-up-text-block">
                <span class="sign-up-text">Already have an account?</span>
                <a href="<?= Url::to('auth/login') ?>" class="sign-in-link brink-link-hover">Sign in</a>
            </div>
        </section>
        <section class="sign-up-form">
            <?php $form = ActiveForm::begin() ?>
            <?= $form->field($model, 'username')->textInput(['placeholder' => 'What\'s your name?']) ?>
            <?= $form->field($model, 'last_name')->textInput(['placeholder' => 'And your last name?']) ?>
            <?= $form->field($model, 'email')->textInput(['placeholder' => 'Email you\'d like to use']) ?>

            <div class="form-group password-wrapper password-inactive">
            ...
            <?= Html::submitButton('Sign me up',['class' => 'sign-up-submit btn-lg']) ?>
            <?php ActiveForm::end() ?>
    ...
    <footer>
        <div class="footer-text-block">
            <span class="sign-up-text">By signing up, you’re agreeing to <a class="sign-in-link brink-link-hover" href="#">the terms and conditions</a> of usage.</span>
        </div>
    </footer>
</div>