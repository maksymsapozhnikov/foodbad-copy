...
class User extends ActiveRecord implements IdentityInterface
{
    ...
    {
        return [
           [['status', 'created_at', 'updated_at', 'suburb_id'], 'integer'],
           [['suburb_id'], 'exist', 'skipOnError' => true, 'targetClass' => Suburb::class, 'targetAttribute' => ['suburb_id' => 'id']],
           ['status', 'default', 'value' => self::STATUS_ACTIVE],
           ['status', 'in', 'range' => [self::STATUS_ACTIVE, self::STATUS_INACTIVE, self::STATUS_DELETED]],
           [['username', 'last_name', 'phone', 'address'], 'string', 'max' => 256],
           ['email', 'email'],
           ['email', 'unique'],
           [['username', 'last_name', 'phone', 'address'], 'filter', 'filter' => 'strip_tags'],
           [['username', 'last_name', 'phone', 'address'], 'filter', 'filter' => 'trim'],
           [['username', 'last_name', 'email'], 'required'],
